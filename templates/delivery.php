<main class="page-delivery">
  ...
  <section class="page-delivery__info">
    ...
    <ul class="page-delivery__list">
      <li>
        <b class="page-delivery__item-title">Стандартная доставка - <?=STANDARD_DELIVERY_COST?> РУБ / БЕСПЛАТНО (ДЛЯ ЗАКАЗОВ ОТ <?=NO_PRICE_MIN_ORDER_COST?> РУБ)</b>
        <p class="page-delivery__item-desc">
          Примерный срок доставки составит около 2-7 рабочих дней, в зависимости от адреса доставки.
        </p>
      </li>
      <li>
        <b class="page-delivery__item-title">В день покупки - <?=ON_DAY_DELIVERY_COST?> РУБ</b>
        <p class="page-delivery__item-desc">
      ...
      <li>
        <b class="page-delivery__item-title">Доставка с примеркой перед покупкой по Москве - <?=STANDARD_DELIVERY_COST?> РУБ / БЕСПЛАТНО (ПРИ ВЫКУПЕ НА СУММУ ОТ <?=NO_PRICE_MIN_ORDER_COST?> РУБ)</b>
        <p class="page-delivery__item-desc">
